 ...
 /**
   ...
   */
	...
	*/
	...
	if (cur.next != null)
		cur.next = new Node<AnyType>(toInsert, cur.next);
...
/*****   Include the main() for testing and debugging  *****/
   ...
   public static void main(String[] args)
   {
	  ...
	  list.insertBefore("h", "zz");
      System.out.println(list);
	  
	  list.insertBefore("a", "xx");
      System.out.println(list);
	  
	  list.insertBefore("s", "cc");
      System.out.println(list);
	  
	  list.insertBefore("v", "should not print out"); // should do nothing
      System.out.println(list);
